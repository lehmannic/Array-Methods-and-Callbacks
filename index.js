...
// console.log("fifaData", fifaData);

// ⚽️ M  V P ⚽️ //

/* Task 1: Investigate the data above. Practice accessing data by console.log-ing the following pieces of data */

// const finals2014 = fifaData.filter( fifa => (fifa['Year']===2014 && fifa['Stage']==="Final"));

let final2014 = fifaData.filter(
  (game) => game['Year'] == 2014 && game['Stage'] === 'Final'
)[0]; // [0] at end grabs the first item in new array making it easier for us to access what we want (below) -- would have to do final2014[0]['Home Team Name']

// (a) Home Team name for 2014 world cup final
let homeTeamName = final2014['Home Team Name'];
...
function getYers(data, getFinals) {
  // create array called years to return
  let years = [];
